...
export type updateRatingResult = (query: Query, data: RatingResultData) => Promise<RatingResultData | null>;
...
export const updateRatingResultUsecase: updateRatingResultSignature =
    (updateRatingResult: UpdateRatingResultRepository) => (query: Query, data: RatingResultData) => {
