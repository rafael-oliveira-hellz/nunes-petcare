...
import { FidelityData, FidelityPaginatedData } from "@/slices/fidelity/entities";
import {
        ...
        UpdateFidelityRepository
{
    ...
    async loadFidelityByPage(query: Query): Promise<FidelityPaginatedData | null> {
        const fidelities = await this.repository.getPaginate(
