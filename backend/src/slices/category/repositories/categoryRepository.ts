...
import { CategoryData, CategoryPaginatedData } from "@/slices/category/entities";
import {
        ...
        UpdateCategoryRepository
{
    ...
    async loadCategoryByPage(query: Query): Promise<CategoryPaginatedData | null> {
        const categories = await this.repository.getPaginate(
